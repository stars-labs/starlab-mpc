...
## Files Modified
- `/apps/tui/src/elm/app.rs` - Main event loop implementation
- `/apps/tui/tests/event_system_test.rs` - New comprehensive test suite
- `/apps/tui/tests/key_handling_test.rs` - Updated for new system
- `/apps/tui/tests/offline_dkg_e2e_test.rs` - Fixed warnings
- `/apps/tui/examples/*.rs` - Fixed various warnings

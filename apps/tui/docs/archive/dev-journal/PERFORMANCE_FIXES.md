...
**Files Changed**:
- `/apps/tui/src/handlers/session_handler.rs`
- `/apps/tui/src/protocal/dkg.rs`
...
**Files Changed**:
- `/apps/tui/src/ui/tui_provider.rs` (lines 497-570)
...
**Files Changed**:
- `/apps/tui/src/ui/tui.rs` (draw_wallet_complete function)
- `/apps/tui/src/bin/starlab-tui.rs` (event loop)
...
**Files Added**:
- `/apps/tui/src/utils/performance.rs`

**Files Modified**:
- `/apps/tui/src/utils/mod.rs`
...
1. **Test Deterministic Addresses** (manual — the standalone script
   that used to live at apps/tui/test_deterministic_address.sh
...
3. **Test UI Performance**:
   ...
   PERF_MONITORING=1 RUST_LOG=info cargo run --bin starlab-tui

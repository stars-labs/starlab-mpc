...
- Runs as the standalone `starlab-tui` binary. Reuses the same
...
```bash
# From the repo root
cargo run --bin starlab-tui -p starlab-client -- --device-id alice
```
...
- **Issues**: [GitHub Issues](https://github.com/hecoinfo/starlab-mpc/issues)
- **Security**: [GitHub Security Advisories](https://github.com/hecoinfo/starlab-mpc/security/advisories/new)

...
See `apps/tui/tests/update_transitions.rs` for the real
...
- `apps/tui/tests/update_transitions.rs` — pure state-machine
  transitions
- `apps/tui/tests/component_rendering.rs` — ratatui snapshot
  tests
...
> `apps/tui/docs/archive/legacy-ui/`. Phase 4's aspirations

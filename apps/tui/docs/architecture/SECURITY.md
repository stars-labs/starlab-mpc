...
`packages/@starlab/core/src/root_secret.rs`.
...
`apps/tui/src/keystore/encryption.rs`:
...
Today only `packages/@starlab/core/src/root_secret.rs`
...
- **Security vulnerabilities**: [GitHub Security Advisories](https://github.com/hecoinfo/starlab-mpc/security/advisories/new)
- **Operational bugs**: [GitHub Issues](https://github.com/hecoinfo/starlab-mpc/issues)
...
For operational bugs, use [GitHub Issues](https://github.com/hecoinfo/starlab-mpc/issues).
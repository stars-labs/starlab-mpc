...
> `apps/tui/docs/guides/USER_GUIDE.md` § Signing Messages →
...
`apps/tui/src/keystore/storage.rs:216-247`. The on-disk
...
What actually ships under `apps/tui/src/`:

...
`packages/@starlab/types/src/messages.ts` (shared workspace
...
**File:** `packages/@starlab/types/src/messages.ts:53` (shared
...
**File:** `packages/@starlab/types/src/messages.ts:190` — real
...
**File:** `packages/@starlab/types/src/messages.ts` — two
...
**File:** `packages/@starlab/types/src/messages.ts` — same
inner/wrapper split:
...
`packages/@starlab/types/src/messages.ts:303`. Illustrative
...
Defined at `packages/@starlab/types/src/messages.ts:262-296`
...
### Key Files
- `packages/@starlab/types/src/messages.ts` — all message
  type definitions (shared workspace package — types aren't
  under the extension's own `src/`)
- `packages/@starlab/types/src/appstate.ts` — application

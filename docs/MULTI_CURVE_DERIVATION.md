...
**Code:** `packages/@mpc-wallet/frost-core/src/{root_secret.rs, unified_dkg.rs, curve_registry.rs, keystore.rs}`
...
- Derivation grammar, versioning, domain separation, salt decision:
  `packages/@mpc-wallet/frost-core/src/root_secret.rs` (module docs + tests).
- N-curve DKG engine: `packages/@mpc-wallet/frost-core/src/curve_registry.rs`.
- Encrypted share storage: `packages/@mpc-wallet/frost-core/src/keystore.rs`.
